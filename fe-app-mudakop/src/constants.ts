...
export const MUDAKOP_LUCI_APP_VERSION = '__COMPILED_VERSION_VARIABLE__';
// FakeIP probe domains. Nothing is hosted behind them - they only need to be present in
// the sing-box FakeIP domain list, so that connecting to one drives traffic through the
// nftables tproxy rules. Keep in sync with FAKEIP_TEST_DOMAIN/CHECK_PROXY_IP_DOMAIN in
// mudakop/files/usr/lib/constants.sh
...
export const DNS_STRATEGY_OPTIONS = {
