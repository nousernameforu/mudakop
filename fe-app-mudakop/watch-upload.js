...
const syncDirs = [
  {
    local: path.resolve(process.env.LOCAL_DIR_FE ?? '../luci-app-mudakop/htdocs/luci-static/resources/view/mudakop'),
    remote: process.env.REMOTE_DIR_FE ?? '/www/luci-static/resources/view/mudakop',
  },
  {
    local: path.resolve(process.env.LOCAL_DIR_BIN ?? '../mudakop/files/usr/bin/'),
    remote: process.env.REMOTE_DIR_BIN ?? '/usr/bin/',
  },
  {
    local: path.resolve(process.env.LOCAL_DIR_LIB ?? '../mudakop/files/usr/lib/'),
    remote: process.env.REMOTE_DIR_LIB ?? '/usr/lib/mudakop/',
  },
  {
    local: path.resolve(process.env.LOCAL_DIR_INIT ?? '../mudakop/files/etc/init.d/'),
