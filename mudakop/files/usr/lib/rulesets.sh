...
# sing-box accepts both address families in a single ip_cidr array, so no family split is needed here.
# IPv6 entries are skipped when IPv6 support is disabled.
